...
//
// class HomeWaitstatus extends StatelessWidget {
//   HomeWaitstatus({
//     Key? key,
//   }) : super(key: key);
//   @override
...
//           ),
//           Pinned.fromPins(
//             Pin(size: 17.0, middle: 0.801),
//             Pin(size: 23.1, middle: 0.5131),
//             child:
...
// const String _svg_lshwg =
//     '<svg viewBox="318.0 491.0 17.0 23.1" ><path transform="matrix(0.999938, 0.011106, -0.011106, 0.999938, 318.25, 491.0)" d="M 0 0 L 16.75496673583984 10.6907787322998 L 0 22.90881156921387" fill="none" stroke="#000000" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
